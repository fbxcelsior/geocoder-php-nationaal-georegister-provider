...
class NationaalGeoregister extends AbstractHttpProvider implements Provider
{
    ...
    protected const DEFAULT_OPTIONS = [
        ...
        'fl' => 'type,centroide_ll,huis_nlt,huisnummer,straatnaam,postcode,woonplaatsnaam,gemeentenaam,gemeentecode,provincienaam,provinciecode,buurtnaam,buurtcode,wijknaam,wijkcode',
    ];
